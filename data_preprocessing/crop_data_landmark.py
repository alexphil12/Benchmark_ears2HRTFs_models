...
def loadtocrop(test=False):
    ...
    for shp in range(6):
        for i in trange(size, desc="Processing images", leave=True): 

            ctr += 1

            if(test):
                o_landmark_path = '/home/PhilipponA/Imported-models/data/test/o_landmarks/test_' + str(i) + '.txt'       # original image path
                o_image_path = '/home/PhilipponA/Imported-models/data/test/o_images/test_' + str(i) + '.png'             # original landmark path
                landmark_path = '/home/PhilipponA/Imported-models/data/test/landmarks/test_' + str(ctr) + '.txt'         # preprocessed image path
                image_path = '/home/PhilipponA/Imported-models/data/test/images/test_' + str(ctr) + '.png'               # preprocessed landmark path
            else:
                o_landmark_path = '/home/PhilipponA/Imported-models/data/train/o_landmarks/train_' + str(i) + '.txt'     # original image path
                o_image_path = '/home/PhilipponA/Imported-models/data/train/o_images/train_' + str(i) + '.png'           # original landmark path
                landmark_path = '/home/PhilipponA/Imported-models/data/train/landmarks/train_' + str(ctr) + '.txt'       # preprocessed image path
                image_path = '/home/PhilipponA/Imported-models/data/train/images/train_' + str(ctr) + '.png'             # preprocessed landmark path
